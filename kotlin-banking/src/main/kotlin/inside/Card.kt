...
class Card(internal val accountId: Int, internal val financialService: Service, private val _openingDate: Calendar) {
    ...
    private val _endingDate = GregorianCalendar(_openingDate[Calendar.YEAR], _openingDate[Calendar.MONTH], _openingDate[Calendar.DATE])
    private val endingDate: String get() = SimpleDateFormat("d/M/Y").format(_endingDate.time)
